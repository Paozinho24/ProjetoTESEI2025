...
class TelaEditarReagente():
    ...
    def tratamento_salvar(self):
        """
        Valida os campos de Nome, Fórmula, CAS, Unidade e Quantidade. 
    ...
    def _finalizar_edicao(self):
        ...
        # Define as ações a serem executadas após o thread de atualização
        ...
        # Define a função a ser executada no thread (chamada ao controller)
        def _do_update():
            try:
        ...
        # Destruímos a janela Toplevel imediatamente.
        try:
