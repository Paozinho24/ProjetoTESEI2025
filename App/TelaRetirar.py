...
class TelaRetirar:
    ...
    def confirmar(self):
        ...
        try:
            ...
            # show on main thread
            try:
                messagebox.showwarning('Erro retirada', 'Erro ao iniciar retirada')
            except Exception:
                messagebox.showwarning('Erro retirada', 'Erro ao iniciar retirada')
    ...
    def _do_retirar(self, qtd, motivo, resp, projeto=None):
        try:
            ...
            try:
                messagebox.showinfo('retirada', 'Retirada realizada com sucesso')
            ...
            try:
                messagebox.showwarning('Erro retirar reagente', 'Erro ao retirar reagente')
            except Exception:
                try:
                    messagebox.showwarning('Erro retirar reagente', 'Erro ao retirar reagente')
                except Exception:
